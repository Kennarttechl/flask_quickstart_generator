...
|2. @app.before_request & @app.after_request | Pre-Request Logging: This helps in tracking the flow of requests and understanding which routes are being accessed. |✅ 
